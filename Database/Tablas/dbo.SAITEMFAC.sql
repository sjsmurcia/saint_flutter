...
/****** Object:  Table [dbo].[SAITEMFAC]    Script Date: 24/08/2025 13:37:37 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[SAITEMFAC](
	...
	[ONroLinea] [int] NOT NULL,
	[ONroLineaC] [int] NOT NULL,
	...
	[CantMayor] [decimal](28, 4) NOT NULL,
	...
	[MtoTaxO] [decimal](28, 4) NOT NULL,
	[PriceO] [decimal](28, 4) NOT NULL,
...
ALTER TABLE [dbo].[SAITEMFAC] ADD  DEFAULT ((0)) FOR [ONroLinea]
GO

ALTER TABLE [dbo].[SAITEMFAC] ADD  DEFAULT ((0)) FOR [ONroLineaC]
GO
...
ALTER TABLE [dbo].[SAITEMFAC] ADD  DEFAULT ((0)) FOR [Signo]
GO
...
ALTER TABLE [dbo].[SAITEMFAC] ADD  DEFAULT ((0)) FOR [CantidadD]
GO

ALTER TABLE [dbo].[SAITEMFAC] ADD  DEFAULT ((0)) FOR [CantidadT]
GO
...
ALTER TABLE [dbo].[SAITEMFAC] ADD  DEFAULT ((0)) FOR [Factor]
GO
...
ALTER TABLE [dbo].[SAITEMFAC] ADD  DEFAULT ((0)) FOR [TipoPVP]
GO

ALTER TABLE [dbo].[SAITEMFAC] ADD  DEFAULT ((0)) FOR [Precio]
GO

ALTER TABLE [dbo].[SAITEMFAC] ADD  DEFAULT ((0)) FOR [PrecioI]
GO

ALTER TABLE [dbo].[SAITEMFAC] ADD  DEFAULT ((0)) FOR [MtoTax]
GO

ALTER TABLE [dbo].[SAITEMFAC] ADD  DEFAULT ((0)) FOR [MtoTaxO]
GO
...
ALTER TABLE [dbo].[SAITEMFAC] ADD  DEFAULT ((0)) FOR [TipoData]
GO

ALTER TABLE [dbo].[SAITEMFAC] ADD  DEFAULT ((0)) FOR [TipoOfe]
GO

ALTER TABLE [dbo].[SAITEMFAC] ADD  DEFAULT (getdate()) FOR [CreatedAt]
GO
