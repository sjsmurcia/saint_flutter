...
/****** Object:  Table [dbo].[SBOPMSTR]    Script Date: 24/08/2025 20:46:20 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[SBOPMSTR](
	...
	[Recobrable] [int] NOT NULL,
	[MtoRec] [decimal](28, 4) NOT NULL,
...
ALTER TABLE [dbo].[SBOPMSTR] ADD  DEFAULT ((0)) FOR [Recobrable]
GO
...
ALTER TABLE [dbo].[SBOPMSTR] ADD  DEFAULT (getdate()) FOR [CreatedAt]
GO
