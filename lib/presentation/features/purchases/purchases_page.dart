...
import '../../../application/purchase/purchase_service.dart';
...
class PurchasesPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return AppScaffold(
      title: l10n?.purchasesTitle ?? 'Compras',
            ...
            return ListView(
              ...
              children: [
                ...
                FilledButton.icon(
                  ...
                  label: Text(l10n?.createPurchaseButton ?? 'Registrar compra'),
                ),
                ...
                if (purchases.isEmpty)
                  Padding(
                    ...
                    child: Center(
                      child: Text(
                        l10n?.purchasesEmpty ?? 'Sin compras registradas',
                      ),
                    ),
                  )
                else
                  for (final purchase in purchases)
                    Card(
                      child: ListTile(
                        ...
                        title: Text(currencyFormatter.format(purchase.total)),
                        subtitle: Text(
                          '${purchase.companyId} / ${purchase.branchId}',
                        ),
                        trailing: Text(
  ...
  Future<double?> _askForTotal(
    ...
    final result = await showDialog<double>(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text(l10n?.createPurchaseButton ?? 'Registrar compra'),
          content: Form(
            key: formKey,
            child: TextFormField(
          ...
          actions: [
            ...
            FilledButton(
              ...
              child: Text(l10n?.createPurchaseButton ?? 'Registrar compra'),
            ),
          ],
        );
      },
